...
static void __helper_on_set_text(CCGraphicTextEdit* edit, char* sources, uint32_t shown_time)
{
    ...
    system_delay_ms(shown_time * 1000);
...
static void __test_common(CCDeviceHandler* handler)
{
    ...
    SET_TEXT_CONV("ccgraphic Test On Base begin", 4);
    ...
    system_delay_ms(1000);
    SET_TEXT_CONV("ccgraphic Test On Base end", 4);
    SET_TEXT_CONV("ccgraphic Test On widget begin", 4);
    ...
    system_delay_ms(1000);
    SET_TEXT_CONV("ccgraphic Test On widget end", 4);
    SET_TEXT_CONV("ccgraphic Test On component begin", 4);
    ...
    system_delay_ms(1000);
    SET_TEXT_CONV("ccgraphic Test On component end", 4);
